function Angulo (f1, f2)
{
	this.forca1 = f1;
	this.forca2 = f2;

	this.pos = createVector(this.forca1.pos.x, this.forca1.pos.y);

	this.angle = (this.forca2.angle - this.forca1.angle);

	if(this.angle > 2*PI - this.angle)
	{
		this.angle = 2*PI - this.angle;
	}

	this.reto = (this.angle==PI/2);
	...
	this.show = function()
	{
		...
		arc(this.pos.x, this.pos.y, 50, 50, this.forca1.angle, this.forca2.angle);
	}
